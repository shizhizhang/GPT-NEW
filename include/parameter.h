...
#if DATATYPE == 1
#define COL 64          		/* Horizontal size of image  */
#define ROW 64          		/* Vertical size of image    */
#define COL2 64          		/* Horizontal size of image  */
#define ROW2 64          		/* Vertical size of image    */
#define CX  32					/* Center of x               */
#define CY  32					/* Center of y               */
#define CX2  32					/* Center of x               */
#define CY2  32					/* Center of y               */

#define MARGINE 0				/* Margine size              */
#define CANMARGIN 0			/* Margine size for calculate crr */
#define TsIMAGE  "chess_rotation_noise/tests30p_n50"
// #define TsIMAGE  "chess_projection/tests_pro_0004"
#define RgIMAGE  "chess_rotation_noise/tests0"
...
#define MARGINE 0				/* Margine size              */
#define CANMARGIN 0			/* Margine size for calculate crr */
#define TsIMAGE  "sample_graf/img5_small2"
#define RgIMAGE  "sample_graf/img1_small"
#define CENTERCORRELATION
/*
 * Memo of the parameter set
 * img1_small to img2_small2 --> ZOOM = 1.6;
 * img1_small to img3_small2 --> ZOOM = 1.5;
 * img1_small to img4_small2 --> ZOOM = 1.6;	Accl ROT = 45.0
 * img1_small to img5_small2 --> ZOOM = 1.0; //0.9
 * img1_small to img6_small2 --> ZOOM = 0.7, ROT = -45.0, BETA = 2, B2 = 20; 20 300
 */
...
#if DATATYPE == 5		/* 10 100 */
#define COL 240          /* Horizontal size of image  */
#define ROW 192          /* Vertical size of image    */
#define COL2 480          /* Horizontal size of image  */
#define ROW2 384          /* Vertical size of image    */
#define CX  120
#define CY  96
#define CX2 240
#define CY2 192
...
#define MARGINE 0				/* Margine size              */
#define CANMARGIN 0			/* Margine size for calculate crr */
#define TsIMAGE  "sample_ubc/img2_small2"
...
#define MARGINE 0				/* Margine size              */
#define CANMARGIN 0			/* Margine size for calculate crr */
#define TsIMAGE  "sample_leuven/img2_small2"
...
#define MARGINE 30				/* Margine size              */
#define CANMARGIN 0			/* Margine size for calculate crr */
